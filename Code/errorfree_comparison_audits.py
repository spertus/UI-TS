...
bets_list = ["fixed", "agrapa", "smooth_predictable", "uniform_mixture"]
...
results = []
for grand_mean, gap, bet, allocation in itertools.product(grand_means, stratum_gaps, bets_list, allocations_list):
